...
import cc.vanishclient.utils.render.TextureRenderer;
...
public final class ArrowESP extends Module {
    private static final Identifier ARROW_TEXTURE = Identifier.of("vanishclient", "textures/visuals/triangle.png");
