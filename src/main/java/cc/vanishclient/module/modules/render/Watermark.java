...
public class Watermark extends Module {
    ...
    private final StringSetting text = new StringSetting("Text", "VanishClient");
    ...
    private void loadIcons() {
        if (fpsIcon == -1) {
            fpsIcon = NanoVGRenderer.loadImage("assets/vanishclient/textures/icons/fps.png");
        }
        if (pingIcon == -1) {
            pingIcon = NanoVGRenderer.loadImage("assets/vanishclient/textures/icons/ping.png");
        }
    }
    ...
    private void onRender2D(Render2DEvent event) {
        ...
        NanoVGRenderer.beginFrame(event.getContext());
    ...
    private Color getColor(int offset) {
        return switch (colorMode.getMode()) {
            ...
            default -> cc.vanishclient.module.modules.client.NewClickGUIModule.getAccentColor();
        };
    }
