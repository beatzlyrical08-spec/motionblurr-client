...
import cc.vanishclient.module.setting.*;
...
public class SettingsPanel {
    ...
    private static Color getAccentColor() {
        return cc.vanishclient.module.modules.client.NewClickGUIModule.getAccentColor();
    }
    ...
    public void render(int mouseX, int mouseY, float alpha) {
        ...
        float transparency = cc.vanishclient.module.modules.client.ClientSettingsModule.getGuiTransparency();
        ...
        float fontSize = 11f;
        NanoVGRenderer.drawText(module.getDisplayName(), currentX + PADDING, y + (HEADER_HEIGHT - fontSize) / 2f, fontSize,
                textColor);
    ...
    private void renderRangeSetting(RangeSetting setting, float settingY, int mouseX, int mouseY, float alpha) {
        ...
        float sliderHeight = cc.vanishclient.module.modules.client.ClientSettingsModule.getSliderHeight();
        ...
        float handleRadius = cc.vanishclient.module.modules.client.ClientSettingsModule.getSliderHandleSize();
    ...
    private void renderBooleanSetting(BooleanSetting setting, float settingY, int mouseX, int mouseY, float alpha) {
        float toggleWidth = cc.vanishclient.module.modules.client.ClientSettingsModule.getToggleWidth();
        float toggleHeight = cc.vanishclient.module.modules.client.ClientSettingsModule.getToggleHeight();
