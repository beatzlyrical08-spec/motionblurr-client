package cc.vanishclient.gui.newgui;

import cc.vanishclient.module.Category;
import cc.vanishclient.module.Module;
import cc.vanishclient.gui.newgui.components.CategoryPanel;
import cc.vanishclient.gui.newgui.components.ConfigPanel;
import cc.vanishclient.gui.FriendsScreen;
import cc.vanishclient.gui.effects.SnowEffect;
import cc.vanishclient.utils.render.nanovg.NanoVGRenderer;
import cc.vanishclient.utils.render.GuiGlowHelper;
...
public class NewClickGUI extends Screen {
    ...
    private void loadContactIcon() {
        if (contactIconImage == -1) {
            contactIconImage = NanoVGRenderer.loadImage("assets/vanishclient/textures/icons/contact.png");
        }
    }
    ...
    private void initPanels() {
        ...
        for (Category category : Category.values()) {
            ...
            List<Module> modules = cc.vanishclient.VanishClient.INSTANCE.getModuleManager().getModulesByCategory(category);
            if (!modules.isEmpty()) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (cc.vanishclient.module.modules.client.ClientSettingsModule.isSnowEffectEnabled()) {
    ...
    private void renderFriendsButton(float alpha) {
        ...
        Color accentColor = cc.vanishclient.module.modules.client.NewClickGUIModule.getAccentColor();
    ...
    public boolean charTyped(char chr, int modifiers) {
        ...
        if (cc.vanishclient.module.modules.client.ClientSettingsModule.isAutoFocusSearchEnabled()) {
    ...
    private void renderPanelGlows(DrawContext context, float alpha, float scale, int centerX, int centerY,
        ...
        if (!cc.vanishclient.module.modules.client.ClientSettingsModule.isGuiGlowEnabled()) {
            return;
        }
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        if (cc.vanishclient.module.modules.client.ClientSettingsModule.isGuiBlurEnabled()) {
