...
public final class Sidebar {
    ...
    public void render(DrawContext context, int x, int y, int width, int height, int mouseX, int mouseY, float alpha, FontRenderer font, FontRenderer smallFont) {
        ...
        Renderer.drawText(context, font, "VanishClient", x + 24, y + 24, ColorPalette.TEXT);
        ...
        Renderer.drawText(context, smallFont, VanishClient.mc != null && VanishClient.mc.getSession() != null ? VanishClient.mc.getSession().getUsername() : "Guest", x + 24, y + height - 50, ColorPalette.SECONDARY);
        Renderer.drawText(context, smallFont, VanishClient.CLIENT_VERSION, x + 24, y + height - 28, ColorPalette.ACCENT);
    }
