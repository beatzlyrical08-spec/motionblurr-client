...
public class SettingsPanel {
    ...
    private static Color getAccentColor() {
        return cc.motionblurr.module.modules.client.NewClickGUIModule.getAccentColor();
    }
    ...
    public void render(int mouseX, int mouseY, float alpha) {
        ...
        float transparency = cc.motionblurr.module.modules.client.ClientSettingsModule.getGuiTransparency();
    ...
    private void renderRangeSetting(RangeSetting setting, float settingY, int mouseX, int mouseY, float alpha) {
        ...
        float sliderHeight = cc.motionblurr.module.modules.client.ClientSettingsModule.getSliderHeight();
        ...
        float handleRadius = cc.motionblurr.module.modules.client.ClientSettingsModule.getSliderHandleSize();
    ...
    private void renderBooleanSetting(BooleanSetting setting, float settingY, int mouseX, int mouseY, float alpha) {
        float toggleWidth = cc.motionblurr.module.modules.client.ClientSettingsModule.getToggleWidth();
        float toggleHeight = cc.motionblurr.module.modules.client.ClientSettingsModule.getToggleHeight();
