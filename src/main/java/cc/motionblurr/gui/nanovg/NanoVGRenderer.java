package cc.motionblurr.gui.nanovg;
...
public final class NanoVGRenderer {
    public static final String ARIAL_RESOURCE = "assets/motionblurr/fonts/Arial.ttf";
    public static final String ARIAL_FACE = "motionblurr-arial";
    private static final Logger LOGGER = LoggerFactory.getLogger("MotionBlurr/NanoVG");
