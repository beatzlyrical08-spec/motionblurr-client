package cc.motionblurr.gui.newgui;

import cc.motionblurr.module.Category;
import cc.motionblurr.module.Module;
import cc.motionblurr.gui.newgui.components.CategoryPanel;
import cc.motionblurr.gui.newgui.components.ConfigPanel;
import cc.motionblurr.gui.FriendsScreen;
import cc.motionblurr.gui.effects.SnowEffect;
import cc.motionblurr.utils.render.nanovg.NanoVGRenderer;
import cc.motionblurr.utils.render.GuiGlowHelper;
...
public class NewClickGUI extends Screen {
    ...
    private void loadContactIcon() {
        if (contactIconImage == -1) {
            contactIconImage = NanoVGRenderer.loadImage("assets/motionblurr/textures/icons/contact.png");
        }
    }
    ...
    private void initPanels() {
        ...
        for (Category category : Category.values()) {
            ...
            List<Module> modules = cc.motionblurr.MotionBlurrClient.INSTANCE.getModuleManager().getModulesByCategory(category);
            if (!modules.isEmpty()) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (cc.motionblurr.module.modules.client.ClientSettingsModule.isSnowEffectEnabled()) {
    ...
    private void renderFriendsButton(float alpha) {
        ...
        Color accentColor = cc.motionblurr.module.modules.client.NewClickGUIModule.getAccentColor();
    ...
    public boolean charTyped(char chr, int modifiers) {
        ...
        if (cc.motionblurr.module.modules.client.ClientSettingsModule.isAutoFocusSearchEnabled()) {
    ...
    private void renderPanelGlows(DrawContext context, float alpha, float scale, int centerX, int centerY,
        ...
        if (!cc.motionblurr.module.modules.client.ClientSettingsModule.isGuiGlowEnabled()) {
            return;
        }
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        if (cc.motionblurr.module.modules.client.ClientSettingsModule.isGuiBlurEnabled()) {
