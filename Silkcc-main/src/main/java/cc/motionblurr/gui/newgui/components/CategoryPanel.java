...
public class CategoryPanel {
    ...
    public void render(int mouseX, int mouseY, float alpha, float scale, int centerX, int centerY) {
        ...
        boolean scrollable = cc.motionblurr.module.modules.client.ClientSettingsModule.isScrollable();
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double amount) {
        if (!cc.motionblurr.module.modules.client.ClientSettingsModule.isScrollable()) {
            return false;
        }
    ...
    public String getTooltipText() {
        if (hoveredModule != null && cc.motionblurr.module.modules.client.ClientSettingsModule.isModuleDescriptionsEnabled()) {
