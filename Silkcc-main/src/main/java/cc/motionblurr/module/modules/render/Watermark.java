...
import cc.motionblurr.utils.render.DraggableComponent;
...
public class Watermark extends Module {
    ...
    private final StringSetting text = new StringSetting("Text", "MotionBlurr");
    ...
    private void loadIcons() {
        if (fpsIcon == -1) {
            fpsIcon = NanoVGRenderer.loadImage("assets/motionblurr/imgs/fps.png");
        }
        if (pingIcon == -1) {
            pingIcon = NanoVGRenderer.loadImage("assets/motionblurr/imgs/ping.png");
        }
    }
    ...
    private Color getColor(int offset) {
        return switch (colorMode.getMode()) {
            ...
            default -> cc.motionblurr.module.modules.client.NewClickGUIModule.getAccentColor();
        };
    }
