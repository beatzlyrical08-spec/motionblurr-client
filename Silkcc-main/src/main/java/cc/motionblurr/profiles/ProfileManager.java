...
public final class ProfileManager {
    ...
    @Getter
    private final File profileDir = MotionBlurrClient.mc != null && MotionBlurrClient.mc.runDirectory != null
            ? new File(MotionBlurrClient.mc.runDirectory, "MotionBlurr" + File.separator + "profiles")
            : new File("profiles");
